  ...
  <body>
    ...
    <nav class="navbar">
      <div class="navbar__container">
        <a href="#" id="navbar__logo"><img src="<?php echo "{$domain}includes/img/logoText.png";?>" alt="logo" class="logo" width="80%"></a>
    ...
    <div class="main">
      <div class="main__container">
        ...
        <div class="main__img--container">
          <img id="main__img" src="<?php echo "{$domain}includes/img/App.png";?>" />
        </div>
      </div>
    </div>
    ...
    <div class="footer__container">
      ...
      <section class="social__media">
        <div class="social__media--wrap">
          ...
          <p class="website__rights">© AndamanTour 2023. All rights reserved</p>
